...
public class PropertySourceTest {
    ...
    public void pspc() {
        ...
        Properties p = new Properties();
        p.put("db.username", "spring");
        PropertySource<?> ps = new PropertiesPropertySource("customPropertySource", p); //프로퍼티 소스 생성
    ...
    @Configuration
    @ImportResource("learningtest/spring/ioc/appconfig2.xml")
    @org.springframework.context.annotation.PropertySource(name="DB Settings", value={"learningtest/spring/ioc/appconfig2.properties"})
