package learningtest.spring.jdbc;
...
public class JdbcTest {
    ...
    public static void init() throws IllegalStateException, NamingException, SQLException {
        ...
        SimpleDriverDataSource ds = new SimpleDriverDataSource(new org.h2.Driver(), "jdbc:h2:tcp://localhost/~/toby", "sa", "");
    ...
    static class SimpleDao {
        ...
        public DataSource dataSource() {
            return new SimpleDriverDataSource(new org.h2.Driver(), "jdbc:h2:tcp://localhost/~/toby", "sa", "");
        }
    }
